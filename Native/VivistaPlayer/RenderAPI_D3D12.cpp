...
//
//	virtual void Create(void* handle, int textureWidth, int textureHeight, int* outRowPitch);
//	virtual void Upload(void* textureHandle, int textureWidth, int textureHeight, int rowPitch, void* dataPtr);
//
//private:
...
//}
//
//void RenderAPI_D3D12::Create(void* textureHandle, int textureWidth, int textureHeight, int* outRowPitch)
//{
...
//
//
//void RenderAPI_D3D12::Upload(void* textureHandle, int textureWidth, int textureHeight, int rowPitch, void* dataPtr)
//{
//	ID3D12Device* device = s_D3D12->GetDevice();
//
